# SENTINEL — Devpost Submission v5.0
...
## TAGLINE
*\$377.93 billion in federal surveillance contracts across 66,576 awards. One agent finds them, traces them, and explains them — in seconds.*
...
### What It Does
SENTINEL is an AI-powered surveillance contract intelligence agent. Users ask plain-English questions and get immediate, sourced answers drawn from a verified dataset of **66,576 government surveillance contracts totaling \$377.93B** in obligated spending.
...
*Submission v5.0 — May 12, 2026. LaTeX math (KaTeX) used only for formulas and set notation; prose uses plain text for currency and counts.*
